...
ถ้าผู้ปกครองสมัครผ่าน LIFF แต่ยังไม่ได้รับการอนุมัติ หน้า LIFF จะเห็นใบสมัครก่อน แต่คอร์สและ timeline อาจยังว่างอยู่จนกว่าสาขาจะอนุมัติและเปิดแพ็กเกจให้เรียบร้อย

ใบสมัครที่มี LINE user id สามารถเปิดสิทธิ์คอร์สผ่าน LINE ได้ทันทีหลังอนุมัติ โดยไม่จำเป็นต้องผูกบัญชีเว็บก่อน การผูกบัญชีเว็บด้วยอีเมลเป็นทางเลือกเพิ่มเติมสำหรับผู้ปกครองที่ต้องการเข้าใช้งานผ่านเว็บไซต์ปกติด้วย
