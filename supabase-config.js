...
// The anon key is safe to expose in browser code when RLS is enabled.
window.SUPABASE_CONFIG = {
  ...
  liffEnrollmentId: "2010468979-OVRveaL1",
  liffStudentId: "2010468979-UjThvD5W",
  liffTeacherId: "2010468979-n1hXPvML"
};
